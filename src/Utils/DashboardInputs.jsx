    ...
    return (
      <div className='flex flex-col gap-[2px]'>
        ...
        <div className="relative">
          <input
            type="text"
            className={`outline-none font-medium text-[19px] text-[#3C3C3C] placeholder:text-[13px] placeholder:tracking-[0.20em] placeholder:font-normal pl-3 pr-10 w-full rounded-[4px] py-2 ${readOnlyOf ? 'bg-[#F5F5F5]' : 'bg-transparent'}`}
            value={formattedDate}
            readOnly
