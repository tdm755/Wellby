    ...
    <>
      <div>
        ...
        >
          <div className="p-5 flex justify-end items-center">
            <span
              className="mr-2 text-white text-xs font-bold cursor-pointer"
              onClick={onClose}
            >
              CLOSE
            </span>
      ...
      <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
        ...
        <p className="text-md mb-4 font-bold">
          <span className="border-b border-[#FFA500] pb-2">Enter your reg</span>
          istered mobile number
        </p>
        <p className="text-sm mb-4">
          Always keep your{" "}
          <span className="font-bold">Personal & Medical details</span> updated
          for <span className="font-bold">First Responder</span> to take prompt
